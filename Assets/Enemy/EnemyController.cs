...
public class EnemyController : MonoBehaviour
{
    ...
    {
        if(Application.isPlaying && canAttack)//ten warunek jest ¿eby zatrzymywa³o siê przy naciœniêciu stop w edytorze XD nie usuwaj tego debilu
        {
